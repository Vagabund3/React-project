  ...
  return (
    ...
    <form onSubmit={props.handleSubmit}>
      <div>
        ...
        {/* Redux-Form будет реагировать на эти Name чтобы обеспечить нашу логику. В Field onChanпу уже засетаны,они будут брать эти name{"} и будут общаться со своим state */}
      </div>
      <div>
